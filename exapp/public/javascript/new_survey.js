/**
/* name: new_survey.js
/* function: normalize and send survey object
/* author: jojahn
/* created on: 12.2017 
*/
...
var app = new Vue({
	...
	methods: {
		...
		// sends generated survey-object to server
		saveSurvey: function() {
			this.buildAnswers();
		...
		// generates survey-object ready to be sent to the server
		buildRequestObject: function() {
			...
			correct = (this.$data.correct != undefined && answers.find(function(x) {
				return x.id == correct
			}).text != null) ? this.$data.correct : null;
